...
|-----|----------|--------------------|-----------------|-----------|----------------------------------------------------------------------------------------|----|
| 1   | 0        | **ユーザー記述ID** | String          | 必須      | アイテムを識別するID。依存関係指定に使用。**ファイル内でユニークであることを強く推奨します。** `Convert-SimpleMdWbsToCsv.ps1` スクリプトは、IDが重複している場合、**ファイル内でより先に出現したアイテムを先行タスクとして解決します。** | `D1`, `TSK001` |
