# SimpleMdWbs 記法 仕様書 Ver. 0.7 (2025-06-03) <-- バージョン更新
...
* 例:
    ...
    %% D1,2025-06-01,2025-07-31,40,先行,PROJ_キックオフ,2025-06-05,2025-07-20,50%,PM田中,全体統括,2025-07-15,最初の主要フェーズです
    ```
...
| バージョン | 日付       | 変更者    | 変更内容                                                                                                                  |
|------------|------------|-----------|---------------------------------------------------------------------------------------------------------------------------|
| 0.7        | 2025-06-03 | IT Legacy | カテゴリ・タスク属性の順序と内容を最終版の13属性に統一。書式例、具体例、記述サンプルをすべて最新仕様に更新。フィールドNo.3の修正。 |
| 0.6        | 2025-06-03 | IT Legacy | 「終了日（実績）」を属性に追加し全13属性に。Excel列名との対応を意識した説明に更新。進捗率形式、コメント位置FIX。          |
