...
詳細な定義は [**`simple-md-wbs` 記法 仕様書 (`../02_Specifications/simple_md_wbs_syntax_spec.md`)**](`../02_Specifications/simple_md_wbs_syntax_spec.md`) を必ず参照してください。
...
* 見出し直後の空行の**次の行**に、`%%`（%%とスペース）で始���て、カンマ区切りで属性を記述します。
* **例（大分類）:**
...
--- <!-- 4. 無視される行の例（区切り線）-->
上記はヒアリング関連のタスクです。このテキスト行もツールに無視されま��。 <!-- 4. 無視される行の例（自由記述）-->
---
...
- 基���設計書作成 <!-- D2C1T1,,,,,,,,設計チーム,,,基本設計は特に重要、時間をかける --> <!-- 属性を大幅に省略した例 -->
